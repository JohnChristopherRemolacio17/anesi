import 'package:capstone_anesi/mangeStore/addProduct/addNoodlesScreen.dart';
...
class SetNoodleScreen extends StatefulWidget {
  @override
  _SetNoodleScreenState createState() => _SetNoodleScreenState();
}

class _SetNoodleScreenState extends State<SetNoodleScreen> {
  final List<String> categories = ['Drinks', 'Noodles', 'Meals', 'sub-category'];
  String selectedCategory = 'Noodles';
              ...
              child: Consumer<ProductRepository>(
                builder: (context, productRepo, child) {
                  final combinedProducts = productRepo.addedProducts
                      .where((product) => product['category'] == 'Noodles')
                      .toList(); // Filter noodles products
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => AddNoodlesProductScreen(
                            onAdd: (newProduct) {
